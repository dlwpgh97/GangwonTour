...
<div class="col-10">
	...
	<!-- 진짜 내용 -->
		...
		<form class="form" action="${pageContext.request.contextPath }/controller3?type=reviewModify&idx=${rvo.idx}" method="post" enctype="multipart/form-data">
			<div class="form-group row">
				<label for="Input1" class="col-sm-2 col-form-label">제목</label>
				<div class="col-sm-10">
				<input type="text" name="title" title="제목" value="${rvo.title }" class="form-control">
				</div>
			</div>
		  ...
		  <div class="form-group row">
		    ...
		    <div class="col-sm-10">
		    <textarea class="form-control" name="content" title="내용" id="Textarea1" rows="15" >${rvo.content }</textarea>
		    </div>
		  </div>
		  <div class="form-group row">
		    <label for="File1" class="col-sm-2 col-form-label">이미지1(썸네일)</label>
		    <div class="col-sm-10">
		    <input type="file" class="form-control-file" name="image1" title="이미지1(썸네일)" value="${rvo.image1 }"id="File1">
		    </div>
		  </div>
		  <div class="form-group row">
		    <label for="File1" class="col-sm-2 col-form-label">이미지2</label>
		    <div class="col-sm-10">
		    <input type="file" class="form-control-file" name="image2" title="이미지2" value="${rvo.image2 }"id="File1">
		    </div>
		  </div>
		  <div class="form-group row">
		    <label for="File1" class="col-sm-2 col-form-label">이미지3</label>
		    <div class="col-sm-10">
		    <input type="file" class="form-control-file" name="image3" title="이미지3" value="${rvo.image3 }"id="File1">
		    </div>
		  </div>
